<template>
  ...
  <div class="container is-fluid mt-3" id="mali">
    <div class="notification has-background-white">
      ...
      <button
        @click="showModal"
        class="button is-info mr-5 ml-3 is-pulled-right"
        id="mali"
        style="margin-top: -30px"
      >
        Add Assignment
      </button>
      <div class="field has-addons ml-6" style="margin-top: -30px">
      ...
      <div class="select mr-5 ml-5 mt-2 is-pulled-right">
  ...
  >
    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <div class="field">
          <label class="label is-size-5 is-pulled-left has-text-primary-dark"
            >ชื่องาน</label
          >
          <div class="control">
            <input
        ...
        <div class="field">
          <label class="label is-size-5 is-pulled-left has-text-link-dark"
            >กำหนดส่ง</label
          >
          <div class="control">
            <input
        ...
        <div class="field">
          <label class="label is-size-5 is-pulled-left has-text-info-dark"
            >เลือกเทอมที่ส่ง</label
          >
          <br /><br />
