<template>
  ...
  <div class="container is-fluid mt-3" id="mali">
      <div class="notification has-background-white">
          ...
          <button @click="showModal" class="button is-info mr-5 ml-5 is-pulled-right" id="mali"
              style="margin-top: -20 px">
              Add Assignment
          </button>
          <div class="field has-addons mt-3" style="margin-top: -30px">
              <div class="control is-expanded">
                  <input class="input" v-model="search" type="text" placeholder="ค้นหา" />
              </div>
          </div>
                      ...
                      <div class="tile is-parent is-vertical ml-4">
                          <article class="tile is-child notification has-background-white">
                              ...
                              <div class="box has-background-danger-light" v-for="nst in NotStarted" :key="nst.number">
                                  ...
                                  <label class="label is-size-6 has-text-grey">วิชา {{ nst.sub_id }} ชื่อ</label>
                                  <label class="label is-size-6 has-text-grey">กำหนดส่ง : {{ nst.deadline }}</label>

                                  <span class="icon is-medium mt-1">
                                      <a @click="showEditModal" class="fa-regular fa-pen-to-square fa-lg mr-3 ml-5"></a>
                                      <a class="fa-solid fa-trash-can fa-lg"></a>
                                  </span>
                      ...
                      <div class="tile is-parent">
                          <article class="tile is-child notification has-background-white">
                              ...
                              <div class="box has-background-warning-light" v-for="wip in Doing" :key="wip.number">
                                  ...
                                  <label class="label is-size-6 has-text-grey">วิชา {{ wip.sub_id }} ชื่อ</label>
              ...
              <div class="tile is-parent">
                  <article class="tile is-child notification has-background-white">
                      ...
                      <div class="box has-background-success-light" v-for="fns in Finished" :key="fns.number">
                          ...
                          <label class="label is-size-6 has-text-grey">วิชา {{ fns.sub_id }} ชื่อวิชา</label>
      ...
      <div class="modal-card">
          ...
          <section class="modal-card-body">
              <div class="field">
                  ...
                  <div class="control">
                      <input class="input is-primary" type="text" placeholder="ชื่อของงาน" id="mali" />
                  </div>
              </div>
              ...
              <div class="field">
                  ...
                  <div class="control">
                      <input class="input is-primary" type="text" placeholder="คำอธิบายเกี่ยวกับงาน" id="mali" />
                  </div>
              </div>
              ...
              <div class="field">
                  ...
                  <div class="control">
                      <input class="input is-primary" type="text" placeholder="รหัสวิชาของงาน" id="mali" />
                  </div>
              </div>
              ...
              <div class="field">
                  ...
                  <div class="control">
                      <input class="input is-link" type="date" placeholder="กำลังส่ง" id="mali" />
                  </div>
              </div>
...
export default {
  ...
  computed: {
      NotStarted: function () {
          return this.sortAssignments.filter((data) => data.asm_status === "ยังไม่เริ่มทำ");
      },
      Doing: function () {
          return this.sortAssignments.filter((data) => data.asm_status === "กำลังทำ");
      },
      Finished: function () {
          return this.sortAssignments.filter((data) => data.asm_status === "เสร็จแล้ว");
      },
  },
  watch: {
      search: function Search(value) {
          value = value.toLowerCase()
          let searchASM = this.Assignments.filter(data => data.sub_id.includes(value) || data.asm_name.toLowerCase().includes(value))
